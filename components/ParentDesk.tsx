...
function VoiceCard() {
  ...
  return (
    <div className="desk-card mt-5 p-5">
      ...
      <p className="mt-2 text-sm text-slate-400">Warm teacher voice for prompts and letter sounds. Tap Again on the kid toolbar to hear it once more.</p>
      <button
        type="button"
      ...
      {configured === false ? (
        <p className="mt-3 text-sm text-amber-200">
          ...
          <span className="font-mono">.env.local</span> or on Vercel. Kids still see the words.
        </p>
      ) : null}
